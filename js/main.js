...
$('#aboutus,#contact,#home,#service').bind('click', function(e) 
        {   
          debugger;
           // debugger;
                 ...
                 /*var o =  $(this) .offset();   
                 var sT = o.top - $("#aboutusdiv").outerHeight(true); // get the fixedbar height
                 // compute the correct offset and scroll to it.
                 window.scrollTo(0,sT);*/
                 //event.preventDefault();
                   var targetId = e.target.id + "div";
